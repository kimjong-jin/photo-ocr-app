...
import { TN_IDENTIFIERS, TP_IDENTIFIERS, P2_SINGLE_ITEM_IDENTIFIERS } from './shared/constants';
      ...
      {activeJob && (
        <div className="space-y-4 pt-4 border-t border-slate-700">
          ...
          <OcrControls
              ...
              isAutoAssignDisabled={isControlsDisabled || !activeJob.processedOcrData || activeJob.processedOcrData.length === 0}
          />
