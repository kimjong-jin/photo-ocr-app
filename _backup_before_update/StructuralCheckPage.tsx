...
const StructuralCheckPage: React.FC<StructuralCheckPageProps> = ({
  ...
  currentGpsAddress, applications, selectedApplication, onSaveDraft, onLoadDraft, onSaveAllDrafts, onLoadAllDrafts, draftMessage
}) => {
                     ...
                     <div className="mt-4 p-3 bg-slate-700/40 rounded-lg border border-slate-600/50">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          {onSaveDraft && (
                            <button
                              onClick={onSaveDraft}
                              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg bg-sky-600 hover:bg-sky-500 text-white transition-colors shadow"
                              title="현재 상태 임시 저장"
                            >
