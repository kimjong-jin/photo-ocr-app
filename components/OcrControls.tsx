    ...
    <div className="space-y-4 pt-2">
            ...
            <div>
              ...
              <div className="relative flex min-w-0">
                <input
                    ...
                    className={`flex-1 min-w-0 w-0 p-2.5 bg-slate-700 border border-slate-500 rounded-md text-sm pr-9 text-slate-200`}
                ...
                {singleAnalysisDate && (
                    <button
                        type="button"
                        onClick={() => onSingleAnalysisDateChange('')}
                        className="absolute inset-y-0 right-0 flex items-center pr-3 text-slate-400 hover:text-white"
                        aria-label="분석 기준 날짜 지우기"
                    >
      ...
      {onInitiateSendToKtl && (
        <div className="space-y-1">
          ...
          >
            {isSendingToClaydox ? (sendingMessage || 'KTL로 전송 중...') : 'KTL로 전송'}
          </ActionButton>
