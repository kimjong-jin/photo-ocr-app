...
export const ChecklistItemRow: React.FC<ChecklistItemRowProps> = ({
  ...
  }, [notes, usesOptionDropdownUi, itemOptions, isCertificateItem, isMarkingCheckItem, isSpecialTocItem]);
  ...
  const showGenericTextarea = !isSpecialTocItem && !usesOptionDropdownUi && !isCertificateItem && !isMarkingCheckItem;
